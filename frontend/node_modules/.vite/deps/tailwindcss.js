...
function me(r, t) {
  ...
  for (let m = 0; m < r.length; m++) {
    ...
    if (!(w2 === ze && (p2 = r.charCodeAt(m + 1), p2 === ie2))) if (w2 === Ve) u2 === "" && (g2 = m), u2 += r.slice(m, m + 2), m += 1;
      ...
      for (let x = m + 1; x < r.length; x++) if (p2 = r.charCodeAt(x), p2 === Ve) x += 1;
        ...
        if (p2 === Le && (r.charCodeAt(x + 1) === ie2 || r.charCodeAt(x + 1) === ze && r.charCodeAt(x + 2) === ie2)) throw new Error(`Unterminated string: ${r.slice(v2, x + 1) + String.fromCharCode(w2)}`);
        if (p2 === ie2 || p2 === ze && r.charCodeAt(x + 1) === ie2) throw new Error(`Unterminated string: ${r.slice(v2, x) + String.fromCharCode(w2)}`);
      }
      u2 += r.slice(v2, m + 1);
    } else {
      if ((w2 === Ne || w2 === ie2 || w2 === Me) && (p2 = r.charCodeAt(m + 1)) && (p2 === Ne || p2 === ie2 || p2 === Me || p2 === ze && (p2 = r.charCodeAt(m + 2)) && p2 == ie2)) continue;
      if (w2 === ie2) {
      ...
      } else if (w2 === Ot && f2[f2.length - 1] !== ")") f2 += "}", c = H2(u2.trim()), i && (c.src = [i, g2, m], c.dst = [i, g2, m]), a && a.nodes.push(c), s2.push(a), a = c, u2 = "", c = null;
        ...
        if (u2.length === 0 && (w2 === Ne || w2 === ie2 || w2 === Me)) continue;
...
var Be = (_a = class {
  ...
  getOptions(t) {
    var _a2;
    return t = ge2(__privateMethod(this, _Be_instances, r_fn).call(this, t)), ((_a2 = this.values.get(t)) == null ? void 0 : _a2.options) ?? 0;
  }
  entries() {
  ...
  markUsedVariable(t) {
    let i = ge2(__privateMethod(this, _Be_instances, r_fn).call(this, t)), e = this.values.get(i);
    if (!e) return false;
    let n = e.options & 16;
...
function ee2(r, t, i = null) {
  for (let e = 0; e < r.length; e++) {
    ...
    if (c === 2) return 2;
    if (c !== 1 && n.kind === "function" && ee2(n.nodes, t, n) === 2) return 2;
  }
}
function Y2(r) {
  let t = "";
...
function D2(r, t, i = [], e = {}) {
  for (let n = 0; n < r.length; n++) {
    ...
    if (s2.kind === "context") {
      if (D2(s2.nodes, t, i, { ...e, ...s2.context }) === 2) return 2;
      continue;
    }
    i.push(s2);
...
function* Xt(r, t) {
  ...
  } else g2 = tr(a, (p2) => t.utilities.has(p2, "functional"));
  for (let [p2, m] of g2) {
...
function Q2(r, t, i) {
  if (!t) return r;
  if (t.kind === "arbitrary") return Z2(r, t.value);
...
function sr(r) {
  ...
  function s2(o, d2) {
    t.functional(o, (h2) => {
      if (!h2.value) return;
      let A2 = null;
      if (h2.value.kind === "arbitrary" ? (A2 = h2.value.value, A2 = Q2(A2, h2.modifier, r)) : A2 = te2(h2, r, d2.themeKeys), A2 !== null) return d2.handle(A2);
  ...
  for (let [o, d2] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) e(`${o}-auto`, [[d2, "auto"]]), e(`${o}-full`, [[d2, "100%"]]), e(`-${o}-full`, [[d2, "-100%"]]), a(o, ["--inset", "--spacing"], (h2) => [l3(d2, h2)], { supportsNegative: true, supportsFractions: true });
  ...
  for (let [o, d2] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) e(`${o}-auto`, [[d2, "auto"]]), a(o, ["--margin", "--spacing"], (h2) => [l3(d2, h2)], { supportsNegative: true });
  ...
  for (let [o, d2, h2] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) a(o, d2, (A2) => [l3(h2, A2)], { supportsFractions: true });
  t.static("container", () => {
    let o = [...r.namespace("--breakpoint").values()];
    o.sort((h2, A2) => we(h2, A2, "asc"));
    let d2 = [l3("--tw-sort", "--tw-container-component"), l3("width", "100%")];
    for (let h2 of o) d2.push(z2("@media", `(width >= ${h2})`, [l3("max-width", h2)]));
    return d2;
    ...
    if (o.value) {
      ...
      if (p(o.value.value)) return o.modifier ? void 0 : [l3("flex", o.value.value)];
    }
  ...
  for (let o of ["x", "y"]) e(`-translate-${o}-full`, [u2, [`--tw-translate-${o}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${o}-full`, [u2, [`--tw-translate-${o}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), a(`translate-${o}`, ["--translate", "--spacing"], (d2) => [u2(), l3(`--tw-translate-${o}`, d2), l3("translate", "var(--tw-translate-x) var(--tw-translate-y)")], { supportsNegative: true, supportsFractions: true });
  ...
  for (let o of ["x", "y", "z"]) n(`scale-${o}`, { supportsNegative: true, themeKeys: ["--scale"], handleBareValue: ({ value: d2 }) => p(d2) ? `${d2}%` : null, handle: (d2) => [f2(), l3(`--tw-scale-${o}`, d2), l3("scale", `var(--tw-scale-x) var(--tw-scale-y)${o === "z" ? " var(--tw-scale-z)" : ""}`)] }), i(`scale-${o}`, () => [{ supportsNegative: true, values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--scale"] }]);
  ...
  function p2({ negative: o }) {
    return (d2) => {
      ...
      if (d2.value.kind === "arbitrary") {
        ...
        if (A2 === "vector") return [l3("rotate", `${h2} var(--tw-rotate)`)];
        if (A2 !== "angle") return [l3("rotate", o ? `calc(${h2} * -1)` : h2)];
  ...
  t.functional("-rotate", p2({ negative: true })), t.functional("rotate", p2({ negative: false })), i("rotate", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
  {
    ...
    for (let h2 of ["x", "y", "z"]) n(`rotate-${h2}`, { supportsNegative: true, themeKeys: ["--rotate"], handleBareValue: ({ value: A2 }) => p(A2) ? `${A2}deg` : null, handle: (A2) => [d2(), l3(`--tw-rotate-${h2}`, `rotate${h2.toUpperCase()}(${A2})`), l3("transform", o)] }), i(`rotate-${h2}`, () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
    n("skew", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}deg` : null, handle: (h2) => [d2(), l3("--tw-skew-x", `skewX(${h2})`), l3("--tw-skew-y", `skewY(${h2})`), l3("transform", o)] }), n("skew-x", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}deg` : null, handle: (h2) => [d2(), l3("--tw-skew-x", `skewX(${h2})`), l3("transform", o)] }), n("skew-y", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}deg` : null, handle: (h2) => [d2(), l3("--tw-skew-y", `skewY(${h2})`), l3("transform", o)] }), i("skew", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-x", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-y", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), t.functional("transform", (h2) => {
      ...
      let A2 = null;
      if (h2.value ? h2.value.kind === "arbitrary" && (A2 = h2.value.value) : A2 = o, A2 !== null) return [d2(), l3("transform", A2)];
  ...
  e("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]), e("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]), e("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]), e("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]), e("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]), e("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
  {
    ...
    for (let h2 of ["solid", "dashed", "dotted", "double", "none"]) e(`divide-${h2}`, [() => M2(":where(& > :not(:last-child))", [l3("--tw-sort", "divide-style"), l3("--tw-border-style", h2), l3("border-style", h2)])]);
  }
  ...
  } }), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
  {
    let h2 = function(C2) {
      ...
      return (R2) => {
        ...
        if (!R2.value) return [l3("--tw-gradient-position", V2), l3("background-image", "conic-gradient(var(--tw-gradient-stops))")];
        let T2 = R2.value.value;
        if (p(T2)) return T2 = C2 ? `calc(${T2}deg * -1)` : `${T2}deg`, [l3("--tw-gradient-position", `from ${T2} ${V2}`), l3("background-image", "conic-gradient(var(--tw-gradient-stops))")];
      };
    };
  ...
  t.functional("bg", (o) => {
    if (o.value) {
      ...
      }
      {
        ...
        if (d2) return [l3("background-color", d2)];
      }
      {
        if (o.modifier) return;
        let d2 = r.resolve(o.value.value, ["--background-image"]);
        if (d2) return [l3("background-image", d2)];
      }
    }
  ...
  function S(o, d2, h2) {
    N2(o, { color(A2) {
      ...
      for (let C2 of ["top", "right", "bottom", "left"]) h2[C2] && (y2.push(l3(`--tw-mask-${C2}`, `linear-gradient(to ${C2}, var(--tw-mask-${C2}-from-color) var(--tw-mask-${C2}-from-position), var(--tw-mask-${C2}-to-color) var(--tw-mask-${C2}-to-position))`)), y2.push(I2([$2(`--tw-mask-${C2}-from-position`, "0%"), $2(`--tw-mask-${C2}-to-position`, "100%"), $2(`--tw-mask-${C2}-from-color`, "black"), $2(`--tw-mask-${C2}-to-color`, "transparent")])), y2.push(l3(`--tw-mask-${C2}-${d2}-color`, A2)));
      return y2;
    }, position(A2) {
      let y2 = [k2(), b2(), l3("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), l3("mask-composite", "intersect"), l3("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
  ...
  e("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]), e("mix-blend-plus-lighter", [["mix-blend-mode", "plus-lighter"]]), e("fill-none", [["fill", "none"]]), t.functional("fill", (o) => {
    ...
    if (o.value) {
      ...
      }
      {
        ...
        if (d2) return [l3("stroke", d2)];
      }
      {
        let d2 = r.resolve(o.value.value, ["--stroke-width"]);
        if (d2) return [l3("stroke-width", d2)];
        if (p(o.value.value)) return [l3("stroke-width", o.value.value)];
      }
    }
  ...
  for (let [o, d2] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) a(o, ["--padding", "--spacing"], (h2) => [l3(d2, h2)]);
  e("text-left", [["text-align", "left"]]), e("text-center", [["text-align", "center"]]), e("text-right", [["text-align", "right"]]), e("text-justify", [["text-align", "justify"]]), e("text-start", [["text-align", "start"]]), e("text-end", [["text-align", "end"]]), a("indent", ["--text-indent", "--spacing"], (o) => [l3("text-indent", o)], { supportsNegative: true }), e("align-baseline", [["vertical-align", "baseline"]]), e("align-top", [["vertical-align", "top"]]), e("align-middle", [["vertical-align", "middle"]]), e("align-bottom", [["vertical-align", "bottom"]]), e("align-text-top", [["vertical-align", "text-top"]]), e("align-text-bottom", [["vertical-align", "text-bottom"]]), e("align-sub", [["vertical-align", "sub"]]), e("align-super", [["vertical-align", "super"]]), n("align", { themeKeys: [], handle: (o) => [l3("vertical-align", o)] }), t.functional("font", (o) => {
    if (!(!o.value || o.modifier)) {
      ...
      }
      {
        ...
        if (d2) return [I2([$2("--tw-font-weight")]), l3("--tw-font-weight", d2), l3("font-weight", d2)];
      }
    }
    ...
    if (o.value) {
      ...
      }
      {
        ...
        if (d2) return o.modifier ? void 0 : [l3("text-decoration-thickness", d2)];
        if (p(o.value.value)) return o.modifier ? void 0 : [l3("text-decoration-thickness", `${o.value.value}px`)];
      }
      {
        let d2 = te2(o, r, ["--text-decoration-color", "--color"]);
        if (d2) return [l3("text-decoration-color", d2)];
      }
    }
  }), i("decoration", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-decoration-color", "--color"], modifiers: Array.from({ length: 21 }, (o, d2) => `${d2 * 5}`) }, { values: ["0", "1", "2"], valueThemeKeys: ["--text-decoration-thickness"] }]), e("animate-none", [["animation", "none"]]), n("animate", { themeKeys: ["--animate"], handle: (o) => [l3("animation", o)] });
  {
    ...
    t.functional("filter", (y2) => {
      if (!y2.modifier) {
        if (y2.value === null) return [h2(), l3("filter", o)];
        if (y2.value.kind === "arbitrary") return [l3("filter", y2.value.value)];
      ...
      if (!y2.modifier) {
        if (y2.value === null) return [A2(), l3("-webkit-backdrop-filter", d2), l3("backdrop-filter", d2)];
        if (y2.value.kind === "arbitrary") return [l3("-webkit-backdrop-filter", y2.value.value), l3("backdrop-filter", y2.value.value)];
        switch (y2.value.value) {
          case "none":
  ...
  }
  {
    ...
    e("transition-none", [["transition-property", "none"]]), e("transition-all", [["transition-property", "all"], ["transition-timing-function", o], ["transition-duration", d2]]), e("transition-colors", [["transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"], ["transition-timing-function", o], ["transition-duration", d2]]), e("transition-opacity", [["transition-property", "opacity"], ["transition-timing-function", o], ["transition-duration", d2]]), e("transition-shadow", [["transition-property", "box-shadow"], ["transition-timing-function", o], ["transition-duration", d2]]), e("transition-transform", [["transition-property", "transform, translate, scale, rotate"], ["transition-timing-function", o], ["transition-duration", d2]]), n("transition", { defaultValue: "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to, opacity, box-shadow, transform, translate, scale, rotate, filter, -webkit-backdrop-filter, backdrop-filter, display, visibility, content-visibility, overlay, pointer-events", themeKeys: ["--transition-property"], handle: (h2) => [l3("transition-property", h2), l3("transition-timing-function", o), l3("transition-duration", d2)] }), e("transition-discrete", [["transition-behavior", "allow-discrete"]]), e("transition-normal", [["transition-behavior", "normal"]]), n("delay", { handleBareValue: ({ value: h2 }) => p(h2) ? `${h2}ms` : null, themeKeys: ["--transition-delay"], handle: (h2) => [l3("transition-delay", h2)] });
    {
      ...
      e("duration-initial", [h2, ["--tw-duration", "initial"]]), t.functional("duration", (A2) => {
        ...
        let y2 = null;
        if (A2.value.kind === "arbitrary" ? y2 = A2.value.value : (y2 = r.resolve(A2.value.fraction ?? A2.value.value, ["--transition-duration"]), y2 === null && p(A2.value.value) && (y2 = `${A2.value.value}ms`)), y2 !== null) return [h2(), l3("--tw-duration", y2), l3("transition-duration", y2)];
      });
    }
  ...
  }
  {
    ...
    t.static("outline-hidden", () => [l3("--tw-outline-style", "none"), l3("outline-style", "none"), z2("@media", "(forced-colors: active)", [l3("outline", "2px solid transparent"), l3("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), t.functional("outline", (d2) => {
      ...
      }
      {
        ...
        if (h2) return [l3("outline-color", h2)];
      }
      {
        if (d2.modifier) return;
        let h2 = r.resolve(d2.value.value, ["--outline-width"]);
        if (h2) return [o(), l3("outline-style", "var(--tw-outline-style)"), l3("outline-width", h2)];
        if (p(d2.value.value)) return [o(), l3("outline-style", "var(--tw-outline-style)"), l3("outline-width", `${d2.value.value}px`)];
      }
  ...
  e("text-shadow-initial", [F2, ["--tw-text-shadow-color", "initial"]]), t.functional("text-shadow", (o) => {
    ...
    }
    {
      ...
      if (h2) return [F2(), l3("--tw-text-shadow-alpha", d2), ...ue2("text-shadow", h2, d2, (A2) => `var(--tw-text-shadow-color, ${A2})`)];
    }
    {
      let h2 = te2(o, r, ["--text-shadow-color", "--color"]);
      if (h2) return [F2(), l3("--tw-text-shadow-color", Z2(h2, "var(--tw-text-shadow-alpha)"))];
    }
  }), i("text-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (o, d2) => `${d2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--text-shadow"], modifiers: Array.from({ length: 21 }, (o, d2) => `${d2 * 5}`), hasDefaultValue: r.get(["--text-shadow"]) !== null }]);
  {
    ...
    e("shadow-initial", [h2, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (V2) => {
      ...
      }
      {
        ...
        if (_2) return [h2(), l3("--tw-shadow-alpha", T2), ...ue2("--tw-shadow", _2, T2, (oe) => `var(--tw-shadow-color, ${oe})`), l3("box-shadow", o)];
      }
      {
        let _2 = te2(V2, r, ["--box-shadow-color", "--color"]);
        if (_2) return [h2(), l3("--tw-shadow-color", Z2(_2, "var(--tw-shadow-alpha)"))];
      }
      ...
      }
      {
        ...
        if (_2) return [h2(), l3("--tw-inset-shadow-alpha", T2), ...ue2("--tw-inset-shadow", _2, T2, (oe) => `var(--tw-inset-shadow-color, ${oe})`), l3("box-shadow", o)];
      }
      {
        let _2 = te2(V2, r, ["--box-shadow-color", "--color"]);
        if (_2) return [h2(), l3("--tw-inset-shadow-color", Z2(_2, "var(--tw-inset-shadow-alpha)"))];
      }
    ...
    t.functional("ring", (V2) => {
      ...
      }
      {
        ...
        if (T2) return [l3("--tw-ring-color", T2)];
      }
      {
        if (V2.modifier) return;
        let T2 = r.resolve(V2.value.value, ["--ring-width"]);
        if (T2 === null && p(V2.value.value) && (T2 = `${V2.value.value}px`), T2) return [h2(), l3("--tw-ring-shadow", y2(T2)), l3("box-shadow", o)];
      }
      ...
      if (!V2.value) return V2.modifier ? void 0 : [h2(), l3("--tw-inset-ring-shadow", C2("1px")), l3("box-shadow", o)];
      if (V2.value.kind === "arbitrary") {
        let T2 = V2.value.value;
        switch (V2.value.dataType ?? pe(T2, ["color", "length"])) {
          case "length":
      ...
      {
        let T2 = te2(V2, r, ["--ring-color", "--color"]);
        if (T2) return [l3("--tw-inset-ring-color", T2)];
      }
      {
        if (V2.modifier) return;
        let T2 = r.resolve(V2.value.value, ["--ring-width"]);
        if (T2 === null && p(V2.value.value) && (T2 = `${V2.value.value}px`), T2) return [h2(), l3("--tw-inset-ring-shadow", C2(T2)), l3("box-shadow", o)];
      }
    ...
    t.functional("ring-offset", (V2) => {
      if (V2.value) {
        ...
        }
        {
          ...
          if (T2) return V2.modifier ? void 0 : [l3("--tw-ring-offset-width", T2), l3("--tw-ring-offset-shadow", R2)];
          if (p(V2.value.value)) return V2.modifier ? void 0 : [l3("--tw-ring-offset-width", `${V2.value.value}px`), l3("--tw-ring-offset-shadow", R2)];
        }
        {
          let T2 = te2(V2, r, ["--ring-offset-color", "--color"]);
          if (T2) return [l3("--tw-ring-offset-color", T2)];
        }
      }
    });
  }
  return i("ring-offset", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--ring-offset-color", "--color"], modifiers: Array.from({ length: 21 }, (o, d2) => `${d2 * 5}`) }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--ring-offset-width"] }]), t.functional("@container", (o) => {
    let d2 = null;
    if (o.value === null ? d2 = "inline-size" : o.value.kind === "arbitrary" ? d2 = o.value.value : o.value.kind === "named" && o.value.value === "normal" && (d2 = "normal"), d2 !== null) return o.modifier ? [l3("container-type", d2), l3("container-name", o.modifier.value)] : [l3("container-type", d2)];
  ...
  return Ci.test(t) ? (i) => {
    ...
    D2(r.nodes, (n) => {
      ...
      ee2(s2, (a) => {
        ...
        if (a.value === "--spacing" && !(e["--modifier"].usedSpacingNumber && e["--value"].usedSpacingNumber)) return ee2(a.nodes, (u2) => {
          var _a2, _b;
...
`);
      ...
      for (let [a, { literals: c, usedSpacingNumber: u2, usedSpacingInteger: f2, themeKeys: g2 }] of [[n, e["--value"]], [s2, e["--modifier"]]]) {
        ...
        if (u2) a.push(...Ze);
        else if (f2) for (let p2 of Ze) p(p2) && a.push(p2);
...
function or(r, t, i) {
  for (let e of t.nodes) {
    if (r.kind === "named" && e.kind === "word" && (e.value[0] === "'" || e.value[0] === '"') && e.value[e.value.length - 1] === e.value[0] && e.value.slice(1, -1) === r.value) return { nodes: B2(r.value) };
    if (r.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
      let n = e.value;
      if (n.endsWith("-*")) {
        n = n.slice(0, -2);
        let s2 = i.theme.resolve(r.value, [n]);
        if (s2) return { nodes: B2(s2) };
      } else {
        let s2 = n.split("-*");
      ...
      if (n === "*") return { nodes: B2(r.value) };
      if ("dataType" in r && r.dataType && r.dataType !== n) continue;
      if ("dataType" in r && r.dataType) return { nodes: B2(r.value) };
      if (pe(r.value, [n]) !== null) return { nodes: B2(r.value) };
    }
  }
}
...
function hr(r) {
  ...
  t.compound("not", 3, (f2, g2) => {
    ...
    if (g2.variant.kind === "arbitrary" && g2.variant.relative) return null;
...
function At(r, t) {
  D2(r, (i, { replaceWith: e }) => {
    ...
    else if (i.kind === "at-rule" && (i.name === "@keyframes" || i.name === "@property")) return Object.assign(i, I2([z2(i.name, i.params, i.nodes)])), 1;
  });
}
function vr(r) {
...
function Oe(r, t) {
  ...
  D2([e], (p2, { parent: m, path: w2 }) => {
    if (p2.kind === "at-rule") {
      if (p2.name === "@keyframes") return D2(p2.nodes, (v2) => {
...
${ne2([w2])}`);
  ...
  for (let p2 of u2) "nodes" in p2 && D2(p2.nodes, (m, { replaceWith: w2 }) => {
    ...
    for (let [N2, b2] of v2.entries()) N2 % 2 === 0 && (x[b2] = k2), k2 += b2.length;
    {
      let N2 = Object.keys(x), b2 = de2(N2, t, { onInvalidCandidate: (K2) => {
        ...
        if (K2 = structuredClone(K2), !S || !F2 || O2 === void 0) return D2([K2], (L2) => {
          L2.src = S;
        }), K2;
        let G2 = [S[0], S[1], S[2]];
  ...
  return function(n, s2) {
    ...
    let u2 = (() => {
      ...
      if (m !== null && typeof m == "object" && !Array.isArray(m)) {
        ...
        for (let v2 in g2) v2 !== "__CSS_VALUES__" && (((_a2 = m == null ? void 0 : m.__CSS_VALUES__) == null ? void 0 : _a2[v2]) & 4 && Cr(w2, v2.split("-")) !== void 0 || (w2[ge2(v2)] = g2[v2]));
        return w2;
      }
...
function Vt({ designSystem: r, ast: t, resolvedConfig: i, featuresRef: e, referenceMode: n }) {
  let s2 = { addBase(a) {
    ...
    for (let [f2, g2] of u2) r.theme.prefix && D2(g2, (p2) => {
      if (p2.kind === "rule") {
...
function ae(r) {
  ...
  } else if (Array.isArray(n)) for (let s2 of n) typeof s2 == "string" ? t.push(l3(e, s2)) : t.push(H2(e, ae(s2)));
  else n !== null && t.push(H2(e, ae(n)));
  return t;
}
function Ur(r, t) {
...
function Xi(r) {
  let t = [];
  if ("keyframes" in r.theme) for (let [i, e] of Object.entries(r.theme.keyframes)) t.push(z2("@keyframes", i, ae(e)));
  return t;
}
function Lr(r) {
...
function nn({ center: r, padding: t, screens: i }, e) {
  ...
  if (typeof t == "object" && t !== null) {
    ...
    for (let [c, , u2] of a) if (s2 && s2.has(c)) s2.get(c).nodes.push(l3("padding-inline", u2));
    else {
      if (s2) continue;
...
function Wr(r) {
  for (let [t, i] of [["t", "top"], ["tr", "top right"], ["r", "right"], ["br", "bottom right"], ["b", "bottom"], ["bl", "bottom left"], ["l", "left"], ["tl", "top left"]]) r.utilities.static(`bg-gradient-to-${t}`, () => [l3("--tw-gradient-position", `to ${i} in oklab`), l3("background-image", "linear-gradient(var(--tw-gradient-stops))")]);
  r.utilities.static("bg-left-top", () => [l3("background-position", "left top")]), r.utilities.static("bg-right-top", () => [l3("background-position", "right top")]), r.utilities.static("bg-left-bottom", () => [l3("background-position", "left bottom")]), r.utilities.static("bg-right-bottom", () => [l3("background-position", "right bottom")]), r.utilities.static("object-left-top", () => [l3("object-position", "left top")]), r.utilities.static("object-right-top", () => [l3("object-position", "right top")]), r.utilities.static("object-left-bottom", () => [l3("object-position", "left bottom")]), r.utilities.static("object-right-bottom", () => [l3("object-position", "right bottom")]), r.utilities.functional("max-w-screen", (t) => {
    ...
    if (!t.modifier) {
      if (!t.value) return [l3("flex-shrink", "1")];
      if (t.value.kind === "arbitrary") return [l3("flex-shrink", t.value.value)];
      if (p(t.value.value)) return [l3("flex-shrink", t.value.value)];
    }
  }), r.utilities.functional("flex-grow", (t) => {
    if (!t.modifier) {
      if (!t.value) return [l3("flex-grow", "1")];
      if (t.value.kind === "arbitrary") return [l3("flex-grow", t.value.value)];
      if (p(t.value.value)) return [l3("flex-grow", t.value.value)];
    }
  });
}
function Br(r, t) {
...
\`@plugin\` options must be a flat list of declarations.`);
          ...
          let b2 = N2.value, S = g(b2, ",").map((P2) => {
            ...
            if (Number.isNaN(Number(P2))) {
              ...
              if (P2[0] === "{" && P2[P2.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${ne2([N2]).trim()}\` is not supported.
...
function Gr({ designSystem: r, base: t, ast: i, sources: e, configs: n, pluginDetails: s2 }) {
  ...
  if (!r.important && f2.important === true && (r.important = true), typeof f2.important == "string") {
    ...
    D2(i, (N2, { replaceWith: b2, parent: S }) => {
      if (N2.kind === "at-rule" && !(N2.name !== "@tailwind" || N2.params !== "utilities")) return (S == null ? void 0 : S.kind) === "rule" && S.selector === k2 ? 2 : (b2(M2(k2, [N2])), 2);
    });
  }
...
function nt(r) {
  ...
  let g2 = nt(u2);
  for (let p2 of g2) for (let m of f2) i.push(e + m + p2);
  return i;
}
function an(r) {
  return Zr.test(r);
        ...
        if (b2.nodes.length === 0) {
          ...
          u2.push((q2) => {
            q2.variants.static(K2, (X2) => {
              ...
              for (let o of G2) re2.push(H2(o, X2.nodes));
              X2.nodes = re2;
            }, { compounds: ye2([...L2, ...G2]) });
          });
          return;
...
${G2}`);
  ...
  if (g2) {
    ...
    for (let P2 of S) r.push(le({ theme: true }, [I2([P2])]));
